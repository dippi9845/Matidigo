...
bool EtherFrameHandler::OnEtherFrameReceived(types::uint8_t* etherframePayload, types::uint32_t size)
{
    return false;
}

void EtherFrameHandler::Send(types::uint64_t dstMAC_BE, types::uint8_t* data, types::uint32_t size)
{
...
bool EtherFrameProvider::OnRawDataReceived(types::uint8_t* buffer, types::uint32_t size)
{
...
void EtherFrameProvider::Send(types::uint64_t dstMAC_BE, types::uint16_t etherType_BE, types::uint8_t* buffer, types::uint32_t size)
{
